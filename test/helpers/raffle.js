...
const enterRaffle = async (
  ...
  const mintAndPlayTicket = async (playerAddress, i) => {
    await raffleTicketInstance.mint(playerAddress, 0, 1, {from: owner});
    await raffleTicketInstance
      .setApprovalForAll(raffleInstance.address, true, {from: playerAddress});
